...
<!-- css for main page -->
		...
		<!-- 		<div class = "arrow bounce">
			...
			<div class = "homeSchedule">
				...
				<div class = "scheduleLeft">
					<img class = "scheduleImage" src="/includes/images/pastor1.1.png">
				</div>
		...
		<!-- 		<div class = "homeBar"></div> -->
			...
			<div class = "about">
				...
				<div class = "aboutBottom" id = "about">
					...
					<div class = "aboutContent">
						...
						with conservative Presbyterian churches, you know that how we worship is very important to
						us. We believe in the regulative principle of worship. To put it simply, on the one hand, we do
						nothing which Scripture forbids us to do in worshipping our Lord. Many churches would agree
